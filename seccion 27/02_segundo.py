...
sns.set("paper") # configura estilos de graficos
...
yhat =  0.2750 * x1 + 0.275 # prediccion de y para cada valor de x ( es decir, y_hat = b0 + b1*x) es la coeficiente de const y Sat
